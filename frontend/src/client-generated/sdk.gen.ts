...
import type { GeminiCancelDeepResearchData, GeminiCancelDeepResearchErrors, GeminiCancelDeepResearchResponses, GeminiDeepResearchSyncData, GeminiDeepResearchSyncErrors, GeminiDeepResearchSyncResponses, GeminiPollDeepResearchData, GeminiPollDeepResearchErrors, GeminiPollDeepResearchResponses, GeminiStartDeepResearchData, GeminiStartDeepResearchErrors, GeminiStartDeepResearchResponses, ItemsCreateItemData, ItemsCreateItemErrors, ItemsCreateItemResponses, ItemsDeleteItemData, ItemsDeleteItemErrors, ItemsDeleteItemResponses, ItemsReadItemData, ItemsReadItemErrors, ItemsReadItemResponses, ItemsReadItemsData, ItemsReadItemsErrors, ItemsReadItemsResponses, ItemsUpdateItemData, ItemsUpdateItemErrors, ItemsUpdateItemResponses, LoginLoginAccessTokenData, LoginLoginAccessTokenErrors, LoginLoginAccessTokenResponses, LoginRecoverPasswordData, LoginRecoverPasswordErrors, LoginRecoverPasswordHtmlContentData, LoginRecoverPasswordHtmlContentErrors, LoginRecoverPasswordHtmlContentResponses, LoginRecoverPasswordResponses, LoginResetPasswordData, LoginResetPasswordErrors, LoginResetPasswordResponses, LoginTestTokenData, LoginTestTokenResponses, PerplexityDeepResearchData, PerplexityDeepResearchErrors, PerplexityDeepResearchResponses, PrivateCreateUserData, PrivateCreateUserErrors, PrivateCreateUserResponses, TavilyCrawlData, TavilyCrawlErrors, TavilyCrawlResponses, TavilyExtractData, TavilyExtractErrors, TavilyExtractResponses, TavilyMapUrlsData, TavilyMapUrlsErrors, TavilyMapUrlsResponses, TavilySearchData, TavilySearchErrors, TavilySearchResponses, UsersCreateUserData, UsersCreateUserErrors, UsersCreateUserResponses, UsersDeleteUserData, UsersDeleteUserErrors, UsersDeleteUserMeData, UsersDeleteUserMeResponses, UsersDeleteUserResponses, UsersReadUserByIdData, UsersReadUserByIdErrors, UsersReadUserByIdResponses, UsersReadUserMeData, UsersReadUserMeResponses, UsersReadUsersData, UsersReadUsersErrors, UsersReadUsersResponses, UsersRegisterUserData, UsersRegisterUserErrors, UsersRegisterUserResponses, UsersUpdatePasswordMeData, UsersUpdatePasswordMeErrors, UsersUpdatePasswordMeResponses, UsersUpdateUserData, UsersUpdateUserErrors, UsersUpdateUserMeData, UsersUpdateUserMeErrors, UsersUpdateUserMeResponses, UsersUpdateUserResponses, UtilsHealthCheckData, UtilsHealthCheckResponses, UtilsTestEmailData, UtilsTestEmailErrors, UtilsTestEmailResponses, YoucomDeepResearchData, YoucomDeepResearchErrors, YoucomDeepResearchResponses } from './types.gen';
 ...
 * Password Recovery
 */
export const loginRecoverPassword = <ThrowOnError extends boolean = false>(options: Options<LoginRecoverPasswordData, ThrowOnError>) => (options.client ?? client).post<LoginRecoverPasswordResponses, LoginRecoverPasswordErrors, ThrowOnError>({
    responseType: 'json',
 ...
 * Health Check
 */
export const utilsHealthCheck = <ThrowOnError extends boolean = false>(options?: Options<UtilsHealthCheckData, ThrowOnError>) => (options?.client ?? client).get<UtilsHealthCheckResponses, unknown, ThrowOnError>({
    responseType: 'json',
 ...
 */
export const tavilySearch = <ThrowOnError extends boolean = false>(options: Options<TavilySearchData, ThrowOnError>) => (options.client ?? client).post<TavilySearchResponses, TavilySearchErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * TavilyAPIError: If the Tavily API request fails.
 */
export const tavilyExtract = <ThrowOnError extends boolean = false>(options: Options<TavilyExtractData, ThrowOnError>) => (options.client ?? client).post<TavilyExtractResponses, TavilyExtractErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * TavilyAPIError: If the Tavily API request fails.
 */
export const tavilyCrawl = <ThrowOnError extends boolean = false>(options: Options<TavilyCrawlData, ThrowOnError>) => (options.client ?? client).post<TavilyCrawlResponses, TavilyCrawlErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * TavilyAPIError: If the Tavily API request fails.
 */
export const tavilyMapUrls = <ThrowOnError extends boolean = false>(options: Options<TavilyMapUrlsData, ThrowOnError>) => (options.client ?? client).post<TavilyMapUrlsResponses, TavilyMapUrlsErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const perplexityDeepResearch = <ThrowOnError extends boolean = false>(options: Options<PerplexityDeepResearchData, ThrowOnError>) => (options.client ?? client).post<PerplexityDeepResearchResponses, PerplexityDeepResearchErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const geminiDeepResearchSync = <ThrowOnError extends boolean = false>(options: Options<GeminiDeepResearchSyncData, ThrowOnError>) => (options.client ?? client).post<GeminiDeepResearchSyncResponses, GeminiDeepResearchSyncErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const geminiStartDeepResearch = <ThrowOnError extends boolean = false>(options: Options<GeminiStartDeepResearchData, ThrowOnError>) => (options.client ?? client).post<GeminiStartDeepResearchResponses, GeminiStartDeepResearchErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const geminiCancelDeepResearch = <ThrowOnError extends boolean = false>(options: Options<GeminiCancelDeepResearchData, ThrowOnError>) => (options.client ?? client).delete<GeminiCancelDeepResearchResponses, GeminiCancelDeepResearchErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const geminiPollDeepResearch = <ThrowOnError extends boolean = false>(options: Options<GeminiPollDeepResearchData, ThrowOnError>) => (options.client ?? client).get<GeminiPollDeepResearchResponses, GeminiPollDeepResearchErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/gemini/deep-research/{interaction_id}',
    ...options
 ...
 */
export const youcomDeepResearch = <ThrowOnError extends boolean = false>(options: Options<YoucomDeepResearchData, ThrowOnError>) => (options.client ?? client).post<YoucomDeepResearchResponses, YoucomDeepResearchErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ scheme: 'bearer', type: 'http' }],
