...
export const YouComDeepResearchRequestSchema = {
    properties: {
        query: {
            type: 'string',
            maxLength: 10000,
        ...
        research_effort: {
            $ref: '#/components/schemas/YouComResearchEffort',
    ...
    title: 'YouComDeepResearchRequest',
    description: 'Request schema for synchronous You.com deep research queries.'
} as const;

export const YouComDeepResearchResponseSchema = {
    properties: {
        output: {
            $ref: '#/components/schemas/YouComOutput',
            description: 'Main You.com research output'
        }
    },
    additionalProperties: true,
    type: 'object',
    ...
    title: 'YouComDeepResearchResponse',
    description: 'Response schema for synchronous You.com deep research queries.'
} as const;

export const YouComOutputSchema = {
    properties: {
        content: {
            type: 'string',
            title: 'Content',
        ...
        sources: {
            items: {
                $ref: '#/components/schemas/YouComSource'
            },
            type: 'array',
            title: 'Sources',
    ...
    type: 'object',
    title: 'YouComOutput',
    description: 'Main You.com research output payload.'
} as const;

export const YouComResearchEffortSchema = {
    type: 'string',
    enum: [
        'lite',
        'standard',
    ...
    title: 'YouComResearchEffort',
    description: 'Research effort levels for You.com deep research queries.'
} as const;

export const YouComSourceSchema = {
    properties: {
        url: {
            type: 'string',
            title: 'Url',
    ...
    title: 'YouComSource',
    description: 'Individual source cited by the You.com research response.'
} as const;
